...
export function SignupForm({
  ...
  const [isGoogleClick, setIsGoogleClick] = useState(false);
        ...
        <CardContent>
          <div className="grid gap-6">
            <div className="flex flex-col gap-4">
              ...
              {
                isGoogleClick ? (<Button disabled>
                  <Loader2 className="animate-spin" />Please wait
                </Button>) : (<Button variant="outline" className="w-full" onClick={() => {
                  setIsGoogleClick(prev => !prev);
